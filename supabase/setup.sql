...
GRANT UPDATE (full_name, email, avatar, family_id, updated_at, age_years, weight_kg, date_of_birth) ON public.profiles TO authenticated;
...
-- ===== 202608150011_update_person_profile.sql =====
CREATE EXTENSION IF NOT EXISTS pgcrypto WITH SCHEMA extensions;
...
-- ===== 202608150012_date_of_birth.sql =====
ALTER TABLE public.profiles
